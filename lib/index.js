...
var funCompleteAppointment = function funCompleteAppointment(BASE_URL, payload, callback) {
  ...
  var url = BASE_URL + 'BizAppointments/markCompleteAppointment?appointmentId=' + appointmentId;
  axios.post(url, payload).then(function (response) {
    return callback(response);
  }).catch(function (error) {
    var json = stringify(error);
...
var funListAppointmentsByService = function funListAppointmentsByService(BASE_URL, payload, callback) {
  ...
  var url = BASE_URL + 'BizAppointments/listAppointmentsByService?businessSiteId=' + bizSiteId + '&businessServiceId=' + bizServiceId + '&pageNo=' + pageNo + '&timeframe=' + timeframe;
  axios.post(url, payload).then(function (response) {
    return callback(response);
  }).catch(function (error) {
    var json = stringify(error);
...
var funListAppointments = function funListAppointments(BASE_URL, payload, callback) {
  ...
  var _month = "";
  if (!isNull(payload["meta"]["month"])) {
    _month = payload["meta"]["month"];
  }
  ...
  var url = BASE_URL + 'BizAppointments/listAppointments?businessSiteId=' + bizSiteId + '&businessClientId=' + bizClientId + '&pageNo=' + pageNo + '&timeframe=' + timeframe + '&month=' + _month + '&year=' + _year;
  axios.post(url, payload).then(function (response) {
    return callback(response);
  }).catch(function (error) {
    var json = stringify(error);
...
var funGetServiceProvidersCalendar = function funGetServiceProvidersCalendar(BASE_URL, payload, callback) {
  ...
  var url = BASE_URL + 'BizAppointments/getServiceProviderCalender?businessSiteId=' + bizSiteId + '&businessServiceProviderId=' + bizServiceProviderId;
  axios.post(url, payload).then(function (response) {
    return callback(response);
  }).catch(function (error) {
    var json = stringify(error);
...
var funGetAppointmentProfile = function funGetAppointmentProfile(BASE_URL, payload, callback) {
  ...
  var url = BASE_URL + 'BizAppointments/getAppointmentDetails?appointmentId=' + appointmentId;
  axios.post(url, payload).then(function (response) {
    return callback(response);
  }).catch(function (error) {
    var json = stringify(error);
